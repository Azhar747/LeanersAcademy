...
public class Teacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<style>\r\n" + "body {\r\n"
				...
				+ "		<input class=\"butt\" type=\"submit\" value=\"Add New Teacher\">\r\n" + "	</form>\r\n"
				+ "</body>\r\n" + "</html>");
		...
		try {
			 stmt=connection.prepareStatement("select * from Teacher");
			 ...
			 out.println("<!DOCTYPE html>\r\n"
			 		...
			 		+ "<tr>\r\n"
			 		+ " <th>ID </th>\r\n"
			 		+ " <th>First Name</th><th>Last Name</th><th>DOB</th><th>Address</th><th>Phone</th><th>Designation</th>\r\n"
			 		+ " </tr>\r\n"
			 		+ " ");
			...
			while(rs.next()) {
			    ...
			    out.println("<tr><td>" + s1 + "</td><td>" + s2 + "</td><td>" + s3 + "</td><td>" + s4 + "</td><td>" + s5 + "</td><td>" + s6 + "</td><td>" + s7 + "</td> </tr>"); 
