...
public class Student extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<!DOCTYPE html>\r\n" + "<html>\r\n" + "<head>\r\n" + "<style>\r\n" + "body {\r\n"
				...
				+ "		<input class=\"butt\" type=\"submit\" value=\"Add New Student\">\r\n" + "	</form>\r\n"
				+ "</body>\r\n" + "</html>");
		...
		try {
			 ...
			 out.println("<!DOCTYPE html>\r\n"
			 		...
			 		+ "<tr>\r\n"
			 		+ " <th>ID </th>\r\n"
			 		+ " <th>First Name</th><th>Last Name</th><th>DOB</th><th>Address</th><th>Class</th><th>Action</th><th>Action</th>\r\n"
			 		+ " </tr>\r\n"
			 		+ " ");
			...
			while(rs.next()) {
			    ...
			    out.println("<tr><td>" + s1 + "</td><td>" + s2 + "</td><td>" + s3 + "</td><td>" + s4 + "</td><td>" + s5 + "</td><td>" + s6 + "</td><td><a class=\"link\" href=\"EditStudent.jsp?id="+s1+"\">Edit</a></td><td><a class=\"link\" href=\"StudentDeleteconfirmation.jsp?id="+s1+"\">Delete</a></td></tr>"); 
